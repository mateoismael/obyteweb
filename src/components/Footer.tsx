        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <div className="font-bold text-xl text-white">Ohanabyte</div>
                <div className="text-gray-400 text-sm">Soluciones TI Perú</div>
              </div>
            </div>
            <p className="text-gray-300 max-w-md mb-6 leading-relaxed">
              Transformamos empresas peruanas a través de soluciones
              tecnológicas innovadoras y confiables. Tu socio estratégico en
              infraestructura TI.
            </p>
            ...
            <ul className="space-y-3 text-sm text-gray-300">
              ...
              <li className="flex items-start gap-2">
                ...
                <div>
                  <div>Gerencia:</div>
                  <a
                    href={`mailto:${SITE.emailGerencia}`}
                    className="hover:text-white transition-colors"
                  >
                    {SITE.emailGerencia}
                  </a>
        ...
        <div className="pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-sm text-gray-400">
              © {year} Ohanabyte S.A.C. Todos los derechos reservados.
            </div>
            <div className="flex flex-wrap items-center gap-6 text-sm">
              ...
              <Link
                to="/legales/libro-de-reclamaciones"
                className="text-gray-400 hover:text-white transition-colors"
              >
